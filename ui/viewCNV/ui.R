...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      h3("Show"),
      selectInput("truth_data", "Truth Data Set", choices=list('GStrip Sn DEL Data', 'CNV Pipeline Sp Data'), selected='CNV Pipeline Sp Data'),
#      checkboxInput("show_CN", "Color Segments by Copy Number", value=TRUE),
      checkboxInput("color_frag", "Color Fragments by Copy Number", value=TRUE),
      tags$table(tags$tr(tags$td(checkboxInput("show_cnv","CNV Extents", value=TRUE)),
                 tags$td(checkboxInput("show_winGeno","Windowed CN Genotypes", value=FALSE)),
      ...
      conditionalPanel("input.show_cnv",
                       ...
                       checkboxInput("show_basic","Show Basic Extents", value=FALSE),
                       checkboxInput("show_extended_cnvs","Show Extended Bounds", value=FALSE),
                       checkboxInput("show_extended_ML", "Show Maximum Likelihood Bounds", value=TRUE),
